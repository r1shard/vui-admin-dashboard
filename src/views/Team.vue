    ...
    <div class="cards">
      <transition appear appear-active-class="animated flipInX">
        <a class="card card-1" :class="{'light-card': !isDarkMode, 'dark-card': isDarkMode}">
          ...
          >Messaging app for all team communcation.</p>
        </a>
      </transition>
      <transition appear appear-active-class="animated flipInX">
      ...
      <transition appear appear-active-class="animated flipInX">
        <a class="card card-3" :class="{'light-card': !isDarkMode, 'dark-card': isDarkMode}">
          ...
          <p :class="{'light-text':isDarkMode,'dark-text':!isDarkMode}">Collaborateive design tool.</p>
        </a>
      </transition>
      <transition appear appear-active-class="animated flipInX">
...
.dark-card {
  ...
  &:hover {
    box-shadow: 0px 15px 30px rgba(123, 66, 246, 0.25);
  }
}
</style>
